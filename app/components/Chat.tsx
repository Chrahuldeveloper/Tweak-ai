  ...
  return (
    <>
      <div id="chatUi" className="bg-[#111827] w-96 rounded-xl ">
        ...
        <div className={` ${toggleBg ? "block" : "hidden"} `}>
          <Backgrounds setChatBg={setchatBg} />
        </div>
        <div
          className={`${
            toggleBg ? "hidden" : "block"
          } relative h-full bg-cover bg-center`}
        ...
        <div
          className={`  ${
            toggleBg ? "hidden" : "block"
          } bg-[#111827] p-5 space-y-3 rounded-b-xl `}
        >
          {isSelect ? (
            <button
